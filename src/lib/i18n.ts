...
const dict = {
  ...
  premiumCollectionSub: { en: "69 bells + 30 backgrounds · SEK 39", sv: "69 klockor + 30 bakgrunder · 39 kr" },
  premiumEverything: { en: "The complete Tringlet collection", sv: "Hela Tringlet-kollektionen" },
  premiumEverythingSub: {
    en: "Unlock 69 hand bells and 30 backgrounds. Available to choose immediately.",
    sv: "Lås upp 69 handklockor och 30 bakgrunder. Kan väljas direkt efter köpet.",
  },
